/**
 * Informacion de una reserva bono registrada en el sistema
...
/**
 * Representa una reserva bono registrada en el sistema
 * Hereda de la clase RFactory
 */

public class ReservaBono extends RFactory{
	
	/**
	 * Crea una nueva reserva bono vacia
	 */
	public ReservaBono() {}
	...
	public ReservaInfantilDTO Crear_Reserva_Infantil(int reservaid, UsuarioDTO user, int pistaid, int idbono, Date fecha_reserva, Date fecha_canjeo, int duracion, int numeromenores) {
		...
		Reserva.setDescuento((float) 0.95);
		if(duracion==60) {
