/**
 * Informacion de una reserva de adultos registrada en el sistema
...
public class ReservaAdultosDTO extends RProduct {
	...
	/**
	 * Constructor vacio.
	 * Crea una nueva reserva de adultos vacia
	 */
	 ...
	 */
	public ReservaAdultosDTO(int reservaid, int userreservaid, int pistaid, int idbono, Date fecha_reserva, Date fecha_canjeo, int duracion, float precio, float descuento, int numeromayores) {
	...
	/**
	 * Metodo toString de la clase ReservaAdultosDTO
	 */

	@Override
	public String toString() {
		return "ReservaAdultosDTO [reservaid=" + reservaid + ", userreservaid="
				...
				+ descuento + ", numeromayores=" + numeromayores + "]";
	}
